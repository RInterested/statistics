...
```{r}
A <- c(12455, 11554, 11908, 13416, 12647, 7828, 10172) # the sample
...
ch_sq <- chisq.test(A, p= expected_freq)
ch_sq$expected
ch_sq
```
...
####Example 5: COMPARING MANUSCRIPTS (modified Jane Austen example):
...
####Example 6: COMPARING DISTRIBUTIONS: RANDOM NUMBER GENERATION:

<br>

We can test how good is [R] at generating random uniform numbers by generating $\small 1 \,million$ draws:
...
####Example 7: COMPARING DISTRIBUTIONS: ARE INVESTMENT RETURNS "NORMAL"?
