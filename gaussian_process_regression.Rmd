...
Note that each curve is a single sample of the (theoretically) infinite-dimensional multivariate Gaussian. Now, we are talking about just a handful of these components or elements in the vector - so a part of a single sample. Why Can we condition of these elements of the vector? This goes back to the initial definition of GP from Wikipedia:
