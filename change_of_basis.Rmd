...
$$\Large\bbox[yellow]{ \text{C}\quad [\vec a]_B \quad=\quad [\vec a]_{\text{standard}}}$$
...
$$\bbox[yellow]{\Large[\vec a]_B\quad= \quad\text{C}^{-1} \quad[\vec a]_{\text{standard}}}$$

In general,

$$\bbox[yellow]{\Large[\vec a]_{\text{new coord.}}\quad= \quad\text{C}^{-1} \quad[\vec a]_{\text{old coord}}}\tag{1}$$
...
$$\Large\bbox[yellow]{\text{D} [\vec x]_B=\quad  [A\vec x]_B \quad= \quad \text{C}^{-1}\quad A\quad \text{C}[\vec x]_B}$$
