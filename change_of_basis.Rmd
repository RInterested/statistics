...
$$\begin{bmatrix}\color{green}{5} & \color{green}{1.5} \\ \color{blue}{-2} & \color{blue}{2.5}\end{bmatrix}^{-1}=\begin{bmatrix}\color{orange}{\frac{5}{31}}&\color{brown}{\frac{-3}{31}}\\\color{orange}{\frac{4}{31}}&\color{brown}{\frac{10}{31}}\end{bmatrix}$$


So now we can look at the Emily's coordinates vector $\begin{bmatrix}\bf y_1\\ \bf y_2\end{bmatrix}$ in Frank's coordinates:

$$\begin{bmatrix}\color{orange}{\frac{5}{31}}&\color{brown}{\frac{-3}{31}}\\\color{orange}{\frac{4}{31}}&\color{brown}{\frac{10}{31}}\end{bmatrix}\begin{bmatrix}{\bf y_1 \\ \bf y_2}\end{bmatrix}=\begin{bmatrix}{\bf x_1 \\ \bf x_2}\end{bmatrix}$$
