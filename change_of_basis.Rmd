...
$$\large\bbox[yellow]{\text{D} [\vec x]_B=\large [A\vec x]_B \quad= \quad \text{C}^{-1}\;A\text{C}[\vec x]_B}$$

We can also see that

$$\text{D}\quad\text{C}^{-1}=\text{C}^{-1}\quad A \text{C}\quad\text{C}^{-1}$$
...
<img width="400" height="400" src="https://cloud.githubusercontent.com/assets/9312897/22325223/152d7eca-e37b-11e6-8d62-38878a20ed22.png">
