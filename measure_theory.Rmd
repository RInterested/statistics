...
A random variable on the probability space $(\Omega, \mathcal F, \mathbb _P)$ is an $\mathcal F$-measurable function from omega to the real line. In math notation: $X: \Omega \rightarrow \mathbb R$.
