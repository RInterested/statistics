...
A random variable $X$ ***pushes the measure*** $\mathbb P$ in $(\Omega, \mathcal F, \mathbb P)$ on the Borel sigma algebra on the real line $\mathbb R$. And $\mathbb P_x$ is the probability measure ***induced by the random variable*** on the Borel sigma algebra on the real line.
