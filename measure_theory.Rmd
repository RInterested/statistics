...
$\mathbb P \Big(\bigcup\limits_{i=1}^\infty A_i \Big)=\displaystyle\lim_{n\to\infty} \mathbb P\Big(\bigcup\limits_{i=1}^n A_i\Big)$.
...
So the inverse of a Borel set is a measurable set to which a probability is assign.

We can write $\mathbb P_X = \mathbb P \circ X^{-1}$, or $\mathbb P$ composition $X$ inverse.

A probability space is $(\mathbb R, \mathcal B(\mathbb R), \mathbb P_X)$: $\mathcal B(\mathbb R)$ is the sigma algebra on $\mathbb R$. 
