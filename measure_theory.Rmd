...
$\begin{align}\color{red}{\text{A BOREL SIGMA ALGEBRA is the generatedby the "interesting subsets" }\mathcal C \text{ (all the open subsets in the real line)}}\end{align}$ (or to put aside for now $\infty$, the $[0,1]$ interval).
