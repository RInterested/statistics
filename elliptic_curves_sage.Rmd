...
The Seed ($x_0$): We need a starting value such that $x_0^2 - 2 \equiv 0 \pmod 5$. We will need to extend the $\mathbb F_5$ field. Let's actually use $x_0 = \alpha$ where $\alpha^2 = 2$ exactly).
...
Step A: The derivative stays the same: $f'(10) = 2(10) = 20$. 
