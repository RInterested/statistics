...
When you find your point $q$ in the field $\mathbb{F}_{p^{234}}$, its coordinates are polynomials like $$x_q = c_0 + c_1 \alpha + c_2 \alpha^2 + \dots + c_{233} \alpha^{233}$$. You take the coefficients of those polynomials (which are just numbers like $0, 1, \dots, p-1$) and you say: "These are now $d_0$. 
