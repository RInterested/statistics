...
$\Large=\,p\Big(\Large\frac{\bar X - \mu_a}{\sigma/\sqrt{n}} > \,z_{1-\alpha}\, -\frac{\mu_a -\mu_o}{s/\sqrt{n}}|\mu=\mu_a\Big)\small \tag 2$
...
$P\left(\frac{\bar X_\Delta}{\sigma_\Delta / 10} > 1.645 ~|~ \mu_\Delta = .01\right) \,[eq.1\,above]
= P\left( \frac{\bar X_\Delta - .01}{.004} > 1. 645 - \frac{.01}{.004} ~|~ \mu_\Delta = .01\right)\,[eq.2\,above]
= P(Z > −.855) = .80$
...
Or note that $\bar X_{\Delta}$ is $N(0.01,0.004)$ under the alternative and we want the $P(\bar X_{\Delta} > 1.645*0.04)$ under $H_a$.
