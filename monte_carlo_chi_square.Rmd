...
This would not be a statistically significant value. So we wouldn't be able to say that there are differences in purchases between regular and occasional clients.
