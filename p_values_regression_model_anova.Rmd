...
- One for each predictor, in the output besides each variable, indicating whether a variable contributes to explaining a significant amount of unique variance.
