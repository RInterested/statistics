...
Looking at the last expression, it is the equivalent of the Pythegorean theorem applied to non-Cartesian coordinates, and we get there thanks to the metric tensor, $g^{ij}$, which role is to raise the index of $dx_i$ from covariant to contravariant.
