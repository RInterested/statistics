...
<img src="cobasis.png" width=900>

---

In the following illustration the vector is invariant, and the basis vectors $(\mathbf e_1, \mathbf e_2)$ keep on increasing in size. To maintain the biorthogonality condition, the dual basis vectors $(\mathbf \varepsilon_1, \mathbf \varepsilon_2)$ are initially large, corresponding to steep gradient. Notice how the idea of a lamp perpendicular to the dual basis vectors is illustrated in the video. 
...
<img src="cobasis_covariant.gif" width=800>
