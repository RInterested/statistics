...
To construct the conditional likelihood is the probability that one of the $M+1$ subjects in the $k$-th matched set is the case and the remainder are the controls:
...
$$L_k = \frac{P({\bf X}_{0k}\mid Y=1) \prod_{i=1}^M P({\bf X}_{ik}\mid Y=0)}{\sum_{l=0}^MP({\bf X}_{lk}\mid Y=1) \prod_{r \neq l}^M P({\bf X}_{rk}\mid Y=0)}$$
Utilizing Bayes' theorem, $P({\bf X}_{ik}\mid Y=1)=\frac{P(Y=1\mid {\bf X}_{ik})\,P({\bf X}_{ik})}{P(Y=1)},$

$$L_k =\frac{\frac{P(Y=1\mid {\bf X}_{0k})\,P({\bf X}_{0k})}{P(Y=1)} \prod_{i=1}^M \frac{P(Y=0\mid {\bf X}_{ik})\,P({\bf X}_{ik})}{P(Y=0)}}{\sum_{l=0}^M\frac{P(Y=1\mid {\bf X}_{lk})\,P({\bf X}_{lk})}{P(Y=1)} \prod_{r \neq l}^M \frac{P(Y=0\mid {\bf X}_{rk})\,P({\bf X}_{rk})}{P(Y=0)}}$$
...
$$L_k =\frac{P(Y=1\mid {\bf X}_{0k})\,P({\bf X}_{0k}) \prod_{i=1}^M P(Y=0\mid {\bf X}_{ik})}{\sum_{l=0}^M P(Y=1\mid {\bf X}_{lk})\,P({\bf X}_{lk}) \prod_{r \neq l}^M P(Y=0\mid {\bf X}_{rk})}\tag 1$$
...
$$P(Y_i=0\mid {\bf X}_{ik}) = \frac{1}{1 + e^{\alpha_k + {\bf X}_{ik}{\bf \beta}}} $$
