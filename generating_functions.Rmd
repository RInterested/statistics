...
Since we have the $\color{purple}{x^4}$ in front of the expansion of the geometric series, we will need to find, NOT the coefficient in front of $x^{\color{brown}{6}}$, BUT RATHER the coefficient in front of $x^{\color{brown}{6}-4}=x^2.$
