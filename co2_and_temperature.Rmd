...
ds[1:2,]  ## show the output to make it easier to understand how this works
```
...
```{r}
VARselect(tsds, lag.max = 10, type='const')
```
...
```{r}
var1 <- VAR(tsds, type="const", lag.max=-4, season=NULL, exogen=NULL)
print(var1)
