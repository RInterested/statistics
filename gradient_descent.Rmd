...
<img width=800 src ="https://cloud.githubusercontent.com/assets/9312897/23903640/93310978-089b-11e7-89e0-f4de4c959f61.png">
...
* Given $\large J(\theta) = -ylog(a^{(L)}) - (1-y)log(1-a^{(L)})$, where $a^{(L)} = h_{\theta}(x))$, the partial derivative is:
