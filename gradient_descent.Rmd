...
So, he is effectively introducing an additional $\delta^{(4)}$, including only the "residuals". In addition, the $\Large\Theta$ factors seem to be included in the $\lambda$'s, althoiugh he also defines:
