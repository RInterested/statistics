...
$\Large\color{blue}{ g'(z)=\frac{e^{-z}}{(1+e^{-z})^2}=\left(\frac{1}{1+e^{-z}}\right)\times \left(1 - \frac{1}{1+e^{-z}}\right)}$ (see embedded mathy picture below for derivation).
...
<img width=400 src="https://cloud.githubusercontent.com/assets/9312897/15807589/1fdf269c-2b30-11e6-9f97-ad17bcd8a993.png">
