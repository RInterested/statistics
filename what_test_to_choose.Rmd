...
> What follows is extracted from [here](https://stats.idre.ucla.edu/other/mult-pkg/whatstat/) and [here](https://stats.idre.ucla.edu/r/whatstat/what-statistical-analysis-should-i-usestatistical-analyses-using-r/).
