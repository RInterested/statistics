...
$$\large \text{odds}=\frac{\Pr(Y=1)}{1-\Pr(Y=1)}$$
...
$$\begin{align}
\large \Pr(Y = 1) &= (1-\Pr(Y=1))\times\,e^{\,\beta_0 + \beta_1 x_1 + \cdots + \beta_p x_p}\\
\large \Pr(Y = 1)\,\times (1 \,+\,e^{\,\beta_0 + \beta_1 x_1 + \cdots + \beta_p x_p}) &= e^{\,\beta_0 + \beta_1 x_1 + \cdots + \beta_p x_p}\\
\large \color{green}{\Pr(Y = 1)} &= \frac{\color{blue}{\text{odds(Y=1)}}}{1\,+\,\color{blue}{\text{odds(Y=1)}}}=\frac{e^{\,\beta_0 + \beta_1 x_1 + \cdots + \beta_p x_p}}{1 \,+\,e^{\,\beta_0 + \beta_1 x_1 + \cdots + \beta_p x_p}}=\frac{1}{1 \,+\,e^{-(\,\beta_0 + \beta_1 x_1 + \cdots + \beta_p x_p)}}
\end{align}$$
...
plot(weight,obese, pch=19, col='tan4')
