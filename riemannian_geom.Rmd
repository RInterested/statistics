...
$$\begin{align}
\lim_{\delta X\to 0}\frac{\delta X^\alpha - \bar \delta X^\alpha}{\delta X}&= \lim_{\delta X\to 0}\frac{\delta X^\alpha }{\delta X}-\lim_{\delta X\to 0} \frac{ \bar \delta X^\alpha}{\delta X}\\[2ex]
