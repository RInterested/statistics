...
The complex residue $R = a + bi$ is the controller.  
...
The following code generates a side-by-side comparison of $f(z) = 1/z$ (Residue = 1) and $g(z) = i/z$ (Residue = $i$). You can see how the colors "twist" while the geometry remains the same.
