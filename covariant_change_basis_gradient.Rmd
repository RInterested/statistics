...
Here we see how Eq 3 tells us now that the shorter the basis vectors in relation to the new basis, the steeper the gradient. Combining Eq 2 with Eq 3,
