...
### COMPARING SAMPLE TO POPULATION PROPORTION - Z-TEST and BINOMIAL TEST:
<br>
...
> Calculate the CI and margin of errors of proportion of university females based on the data `survey` within the package `MASS`. This is extracted from [here](https://www.r-tutor.com/elementary-statistics/interval-estimation/interval-estimate-population-proportion):
...
pbar = k/n # Proportion of females among responders
...
paste('At',100*(1 - 0.05),'percent confidence level, between', 100 * round(pbar-E,3), 
      ...
      'percent of the university students are female, and the margin of error is', 
      100 * round(E,3),'percent.')
```
