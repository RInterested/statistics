...
which corresponds to a proportion $\hat p$ value to reject $H_o$ of

$$\hat p = p + z \sqrt{\frac{p(1-q)}{n}}$$
...
p = 0.2
n = 20
qnorm(0.975) * sqrt((p * (1 - p)) / n) + p
```


<img height=350, width=450
src='https://user-images.githubusercontent.com/9312897/109200165-47d23b00-776e-11eb-8791-36f75933b878.png'>
