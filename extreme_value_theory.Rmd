...
# Under normality, and with the empirical mean and sd calculated from the date, the observed values above VaR would be:
...
the log-Fr&eacute;chet distribution will have $\color{yellow}{\text{location }\log\sigma}$ and parameter $\color{yellow}{\text{scale }\frac{1}{\xi}}$.
