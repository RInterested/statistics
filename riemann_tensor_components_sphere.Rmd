...
References online [here](https://physics.stackexchange.com/a/733752/150551) and [here](https://sites.math.washington.edu/~morrow/336_20/papers17/carson.pdf), and the code for the Riemann curvature tensor, the Ricci tensor and the curvature is [here](https://www.wolframcloud.com/obj/antoniparellada/Published/Schwarzschild.nb).
