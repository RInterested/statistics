...
The [backpropagation partial derivatives](http://neuralnetworksanddeeplearning.com/chap3.html) would work like this:

$$\begin{eqnarray}
  \frac{\partial C}{\partial w_j} & = & -\frac{1}{k} \sum_k \left(
    \frac{y_k }{\sigma(z_k)} -\frac{(1-y_k)}{1-\sigma(z_k)} \right)
  \frac{\partial \sigma(z_k)}{\partial w_j} \\
 & = & -\frac{1}{k} \sum_k \left( 
    \frac{y_k}{\sigma(z_k)} 
    -\frac{(1-y_k)}{1-\sigma(z_k)} \right)\sigma'(z_k) x_j\\
& = &  \frac{1}{n}
  \sum_x \frac{\sigma'(z_k) x_j}{\sigma(z_k) (1-\sigma(z_k))}
  (\sigma(z_k)-y_k)
\end{eqnarray}$$

As for the $\sigma'$ derivative,

<img src = "https://cloud.githubusercontent.com/assets/9312897/23877727/105a071a-081a-11e7-9036-4514b85cd771.png" width = 400>
