...
We can decomose $\mu = \begin{bmatrix}\mu_a\\\mu_b\end{bmatrix}$

and $\Sigma$ into the block matrix $\Sigma = \begin{bmatrix}\Sigma_{aa}&\Sigma_{ab}\\\Sigma_{ba}&\Sigma_{bb}\end{bmatrix}$. This is a block matrix because $\Sigma_{aa}=\begin{bmatrix}C_{11}&\dots&C_{1k}\\\vdots&\ddots&\vdots\\C_{k1}&\dots&C_{kk}\end{bmatrix}$
...
$A = \begin{bmatrix}1&0&0&0&0&\dots&0&&0&0&0&\dots&0\\
                0&1&0&0&0&\dots&0&&0&0&0&\dots&0\\
                0&0&1&0&0&\dots&0&&0&0&0&\dots&0\\
                0&0&0&1&0&\dots&0&&0&0&0&\dots&0\\
                0&0&0&0&1&\dots&0&&0&0&0&\dots&0\\
                \vdots\\
                0&0&0&0&0&\dots&1&&0&0&0&\dots&0\\
\end{bmatrix}$ which is $(k \times n)$.
...
For a full derivation see [here](statistics/Inverse and determinant of partitioned symmetric matrix.pdf) and [here](statistics/Marginal and conditional distributions of multivariate normal distribution.pdf).
