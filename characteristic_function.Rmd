...
$$\Large\varphi_X(t)=\mathbb E[e^{itX}]$$
...
\begin{align}\Large \varphi(t) &= \mathbb E[e^itX]\\
&= \int_{-\infty}^{+\infty} e^{itX} \frac{1}{\sqrt{2\pi}}e^{-\frac{x^2}{2}} dx\\
&=\int_{-\infty}^{+\infty} \color{blue}{\frac{e^{\frac{-t^2}{2}}}{\sqrt{2\pi}}e^{\frac{t^2}{2}}}e^{itx} e^{-\frac{x^2}{2}} dx\\
&=\frac{e^{\frac{-t^2}{2}}}{\sqrt{2\pi}}\int_{-\infty}^{+\infty}e^{\frac{t^2}{2}}e^{itx} e^{-\frac{x^2}{2}} dx\\
...
<img height="200"  src="https://cloud.githubusercontent.com/assets/9312897/21082647/ca2d7f42-bfad-11e6-97b3-065b0635fde1.png">
