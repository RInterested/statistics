...
$$\text{Growth Rate} = \frac{1}{n} \sum \log(1+r_i) \xrightarrow{n \to \infty} \mathbb{E}[\log(1+r)]$$
...
The second term is the volatility; a tax on our compounding. $r_a$ is the engine (the arithmetic mean), while $-\frac{\sigma^2}{2}$: This is the friction (the volatility drag).
