...
Here is an example with $100$ paths:
...
set.seed(42)
num_paths   <- 500    
num_steps   <- 100     # Fixed: Shortened time horizon lets outliers appear in a small sample pool
...
p %>% layout(
  title = "Ole Peters' Fair Coin Toss: The Isolated Outliers Driving the Mean (100 Steps)",
  showlegend = FALSE,
  plot_bgcolor = "white",
  xaxis = list(title = "Time Steps (Flips)", gridcolor = "rgba(240,240,240,1)"),
