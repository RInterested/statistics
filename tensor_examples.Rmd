...
Compare this to the permutations in the indices when contracting $i$ and $j$ in $T^{ij}_{\phantom{ij}kl}$:


$$\begin{array}{l|r}
i = j = 1 & i = j = 2\\
\hline
a_{\color{red}{11}} b_{kl} & a_{\color{red}{22}} b_{kl}\\
\hline
a_{11} b_{11} & a_{22} b_{11}\\
a_{11} b_{12} & a_{22} b_{12}\\
a_{11} b_{21} & a_{22} b_{21}\\
a_{11} b_{22} & a_{22} b_{22}
\end{array}
$$
arranged in matrices as
