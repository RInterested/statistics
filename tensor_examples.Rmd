...
This is a different block matrix from the starting one:
...
\end{bmatrix} 
 $$
It actually reverts the order. What would happen if we used the original matrix? We'd be contracting $\color{red}j$ and $\color{red}l$: 
...
Compare this to the permutations in the indices when contracting $i$ and $k$ in $T^{\color{red}{i}j}{}_{\color{red}{k}l}$:
