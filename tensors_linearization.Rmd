...
A bilinear form can be expressed as a matrix $A$, and the function be interpreded as multiplying on the left by a row vector $\vec v^\top$ and on the right by a column vector $\vec w$ as in 
