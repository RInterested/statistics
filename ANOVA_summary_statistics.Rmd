...
It's worth at this point remembering that the sample variance is calculated as $s^2=\frac{\sum (x_i - \bar x )^2}{n-1}$ so that the $\text{SS}_{\text{within groups}}= (n-1) s^2.$
