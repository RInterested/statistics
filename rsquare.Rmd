...
Just a bit of a misunderstanding with the [definitions](https://en.wikipedia.org/wiki/Coefficient_of_determination#Definitions), I believe:
...
After the (-1) without explanation, I made sure with a quick example that I hadn't messed up the formulas:
