...
and we can obtain the partial derivative with respect to any of the curvilinear coordinates:

$$\varepsilon_i = \frac{\partial \vec r}{\partial u^i}= \frac{\partial x^1}{\partial u^i} \vec e_1 + \frac{\partial x^2}{\partial u^i} \vec e_2 + \frac{\partial x^3}{\partial u^i} \vec e_3$$
