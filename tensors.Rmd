...
$$T^p_q\,V = \underset{p}{\underbrace{V\otimes\cdots\otimes V}} \otimes \underset{q}{\underbrace{V^*\otimes\cdots\otimes V^*}}:=\{T | T \text{ is a (p,q) tensor}\}$$ is the set of all tensors where $T$ is (p,q). 
