...
$$\begin{bmatrix}
\frac{\partial \varphi}{\partial y^1}\\\frac{\partial \varphi}{\partial y^2}\\\frac{\partial \varphi}{\partial y^3}\\\vdots\\\frac{\partial \varphi}{\partial ynd}
\end{bmatrix}=
{\begin{bmatrix}
...
\vdots&\vdots&\vdots&&\vdots\\
\frac{\partial x^1}{\partial y^n} & \frac{\partial x^2}{\partial y^n} & \frac{\partial x^3}{\partial y^n} &\cdots& \frac{\partial x^n}{\partial y^n}\\
\end{bmatrix}}
\large\color{red}{\begin{bmatrix}
...
This arrangement (red column vector) is the form that defines **covariant vectors** - for example $W:$
