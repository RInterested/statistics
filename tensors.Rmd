...
$$\Large \color{green}{Z^{i'}} = \color{red}{Z^{i'}}\left(Z^i\right)$$

where $\color{red}{Z^{1'}}$ is $\sqrt{x^2 + y^2}$ for $\color{green}{Z^{1'}} = r$, and $\color{red}{Z^{2'}}$ is $\arctan(y,x)$ for $\color{green}{Z^{2'}}=\theta.$
