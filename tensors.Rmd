...
$$T^p_q\,V = \underset{p}{\underbrace{V\otimes\cdots\otimes V}} \otimes \underset{q}{\underbrace{V^*\otimes\cdots\otimes V^*}}:=\{T | T \text{ is a (p,q) tensor}\}=\{T: \underset{p}{\underbrace{V^*\times \cdots \times V^*}}\times \underset{q}{\underbrace{V\times\times \cdots  V\times V}} \overset{\sim}\rightarrow K\}$$ is the set of all tensors where $T$ is (p,q). 
