...
Notice that in this case $n = d$ (the $d$ in the matrix above), while $m$ is a dummy index.
...
$$\Large \bbox[10px, border:2px solid red]{T_{mn}^{(Y)}= \frac{\partial x^{\color{blue}{r}}}{\partial y^m}\frac{\partial x^{\color{blue}{s}}}{\partial y^n}T_{\color{blue}{rs}}^{(x)}}$$

There are mixed tensors, such as:

$$\Large T^n_m(y) =\frac{\partial x^{\color{red}{r}}}{\partial y^m}\frac{\partial y^n}{\partial x^{\color{blue}{s}}}T^{\color{blue}{s}}_{\color{red}{r}}(x)$$
