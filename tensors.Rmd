...
$$\vec A = a^1\, \varepsilon_1 + a^2 \, \varepsilon_2 + a^3 \, \varepsilon_3\tag 4$$
...
So a vector $\vec A$ as in equation $(4)$ above can be expressed as a linear function of contravariant vectors:
