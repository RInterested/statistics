...
$$A^m_{(y)}=\frac{\partial y^m}{\partial x^r} A^r_{(x)}$$

$$B^n_{(y)}=\frac{\partial y^n}{\partial x^s} B^s_{(x)}$$

Multiplying them,

$$A^m_{(y)}B^n_{(y)}=\frac{\partial y^m}{\partial x^r}\frac{\partial y^n}{\partial x^s}A^r_{(x)}B^s_{(x)}$$

$$T^{mn}_{(Y)}= \frac{\partial y^m}{\partial x^r}\frac{\partial y^n}{\partial x^s}T^{rs}_{(x)}$$
