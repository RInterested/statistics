...
$$T(s) = \frac{dR(s)}{ds}=\frac{\partial R}{\partial Z^1}\frac{dZ^1}{dS} + \frac{\partial R}{\partial Z^2}\frac{dZ^2}{dS} = \frac{\partial Z^1}{ds}{\bf e_1} + \frac{\partial Z^2}{ds} {\bf e_2}$$
