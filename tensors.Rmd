...
\frac{\partial y}{\partial \color{red}{r}}   = 1$

$\Large\frac{\partial\color{red}{r}}{\partial x}  
\frac{\partial x}{\partial \color{red}{\theta}}
+ \frac{\partial\color{red}{r}}{\partial y}  
\frac{\partial y}{\partial \color{red}{\theta}}   = 0$
...
\frac{\partial y}{\partial \color{red}{r}}   = 0$

$\Large\frac{\partial\color{red}{\theta}}{\partial x}  
\frac{\partial x}{\partial \color{red}{\theta}}
+ \frac{\partial\color{red}{\theta}}{\partial y}  
\frac{\partial y}{\partial \color{red}{\theta}}   = 1$
...
$$\Large \color{red}{Z^{i'}}\left(\color{red}{Z}(\color{green}{Z'})\right) = \Large \color{green}{Z^{i'}}$$

... wording this..."by taking the $r$, $\theta$ ($\color{red}{Z^{i'}}$) and lookng at how they depend on $x$ and $y$ ($\large Z$), and plugging the dependence of $x$, $y$ on $r$ and $\theta$, i.e. ($\cdot(Z')$), you recover the $r$ and $\theta$.
