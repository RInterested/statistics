...
$$\large \vec \varepsilon_j = \frac{\partial \vec r}{\partial u^j}=  \frac{\partial u^{'i}}{\partial u^j} \frac{\partial \vec r}{\partial u^{'i}}= \frac{\partial u^{'i}}{\partial u^j} \vec \varepsilon'_i$$
...
$$\large \vec A = a^{'i}\vec \varepsilon'_i = a^j\varepsilon_j$$
