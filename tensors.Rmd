...
$$T: \underset{p}{\underbrace{V^*\times \cdots \times V^*}}\times \underset{q}{\underbrace{V\times\times \cdots  V\times V}} \overset{\sim}\rightarrow K$$
...
Hence the tensor space is a vector space.
