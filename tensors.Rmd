...
<img width="700" height="500" src="https://cloud.githubusercontent.com/assets/9312897/22534984/e1a0cd5a-e8c5-11e6-9273-497daf7b18cf.png">
...
<img width="900" height="700" src="https://cloud.githubusercontent.com/assets/9312897/22517840/8098f58e-e878-11e6-92c0-63db45d34174.png">
...
<img width = 1000 src="https://cloud.githubusercontent.com/assets/9312897/22622170/790b853a-eb01-11e6-9822-920e87caf3bd.png">

These are not unit vectors, but can be normalized dividing by the norm:

$$\Vert \frac{\partial \vec r}{\partial u^i}\Vert$$

This fact make it very easy to express a vector $\vec A$ as the tangent vectors multiplied by a scalar:

<img width="500" height="300" src="https://cloud.githubusercontent.com/assets/9312897/22522176/b289160e-e888-11e6-87ec-b4ba397e78cc.png">
...
$$\begin{align}\varepsilon_i \cdot \varepsilon^j &= \frac{\partial x^1}{\partial u^i}\frac{\partial u^j}{\partial x^1}+\frac{\partial x^2}{\partial u^i}\frac{\partial u^j}{\partial x^2}+\frac{\partial x^3}{\partial u^i}\frac{\partial u^j}{\partial x^3}\\[2 ex]
&= \frac{\partial u^j}{\partial u^i}
\end{align}$$
...
So these two elements are orthogonal.
