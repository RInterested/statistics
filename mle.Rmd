...
Now the $\sum_{i=1}^n(y_i -(\alpha + \beta x_i))$ is the estimated error, and $\color{blue}{0=\sum_{i=1}^nx_i(y_i -(\alpha + \beta x_i))}$ one of the [conditions of classical OLS](https://en.wikipedia.org/wiki/Ordinary_least_squares#Assumptions).
