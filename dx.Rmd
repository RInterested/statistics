...
Following [Prof. Shifrin's youtube explanation](https://youtu.be/Rci22jC_pS8), and [XylyXylyX's Invitation to n forms](https://youtu.be/yvH1ECuc7YU). Of note we can call them k-forms, as well.
...
He describes for any open set, $U\subset \mathbb R^n,$ the vector space of the form
