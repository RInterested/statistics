...
$$\large g^{(y)}_{\color{red}{rs}}=\delta_{mn}\frac{\partial x^m}{\partial y^\color{red}{r}}\frac{\partial x^n}{\partial y^\color{red}{s}}\tag 3$$
...
$$\large d\vec r = \vec \varepsilon_1 d u^1 + \vec \varepsilon_2 d u^2 + \vec \varepsilon_3 d u^3+ \cdots = \vec \varepsilon_i du^i$$
...
$$\Large\bbox[10px, border:2px solid aqua]{\vec \varepsilon_i\vec \varepsilon_j = g_{ij}}\tag 4$$
