...
transformations of this metric tensor between two systems of curvilinear coordinates, where the expression of this metric tensor in this second system is $g'_{ij}= \vec \varepsilon'_i \varepsilon'_j$ will be given by:
