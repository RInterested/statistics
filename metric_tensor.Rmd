...
> KEY CONCEPT: The dot product of two unit tangent vectors (contravariant) is the metric tensor (same goes for the dot product between orthogonal vectors (covariant)), whereas the dot product between unit tangent and orthogonal vectors is the [Kronecker delta](https://en.wikipedia.org/wiki/Kronecker_delta).
