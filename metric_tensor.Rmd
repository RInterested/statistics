...
$$dS^2 = \large \delta_{mn} \;dX^m\, dX^n= \large \underset{\text{METRIC TENSOR}}{\underbrace{\delta_{mn}\frac{\partial x^m}{\partial y^r}\frac{\partial x^n}{\partial y^s}}} \;dy^r\; dy^s$$
