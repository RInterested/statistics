...
where $t(x)$ is the sufficient statistic; $\theta$ are the natural parameters, $\left<\;,\;\right>$ is the inner product (commonly called dot product), $F(\cdot)$ is the log-normalizer, and $k(x)$ is the carrier measure. 
