...
$\Huge\bar Y -\hat\beta_1 \bar X_1 -\hat\beta_2 \bar X_2 =\hat\beta_o$
...
$\Large\hat\beta_1=\frac{\Large\displaystyle\sum_{i=1}^nx_{1i}(y_i-\bar Y)}{\Large\displaystyle\sum_{i=1}^nx_{1i}(x_{1i}-\bar X_1)}- \hat\beta_2\frac{\Large\displaystyle\sum_{i=1}^n x_{1i}(x_{2i}-\bar X_2)}{\Large\displaystyle\sum_{i=1}^n x_{1i}(x_{1i}-\bar X_1)}$ compare to the formula with prior method through the origin (equation (11)):
