...
$$\Gamma\left(\frac{1-s}2\right)\,\pi^{-(1-s)/2} \, \zeta(1-s)= \int_{1}^\infty  \,\left( x^{-\frac{1 - s}{2} - \frac 1 2}+x^{\frac{1 - s} 2 - 1}\right) \, \psi(x) \, dx -\frac 1 {s(1-s)}\\=
...
$$\pi^{-\frac 1 2 z}\, \Gamma\left(\frac 1 2 z\right)\,\zeta(z) = \int_1^\infty \omega(u)\, u^{\frac 1 2 z - 1} du + \int_1^\infty v^{-1}\,\color{lime}{\omega(v^{-1})}\, v^{-\frac 1 2 z+1}dv$$
...
$$\xi(z)= \frac 1 2 + \frac 1 2 z(z-1) \left( \int_1^\infty \omega(u)\, u^{\frac 1 2 z-1} \, du + \int_1^\infty v^{-\frac 1 2 z - \frac 1 2}\,\omega(v)\,dv\right)=\xi(z-1)$$
...
we finally arrive at the **ANALYTIC CONTINUATION:**
