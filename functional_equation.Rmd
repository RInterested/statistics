...
The [Riemann Xi or completed zeta function](https://proofwiki.org/wiki/Definition:Completed_Riemann_Zeta_Function) makes the function symmetric. Notice the plot for real input values:
