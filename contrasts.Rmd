...
For contrasts to be *orthogonal* their dot products have to be zero, and the number of comparisons identical to the $df$ for treatments.
...
```{r}
(L_2 = 1 * M[2] - 1/3 * M[3] - 1/3 * M[4] - 1/3 * M[5])
