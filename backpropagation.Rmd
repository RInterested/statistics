...
2. We want to update $W_2$, and finding our way back the NN tree:

What we want is to update the weights backpropagating the error as:

$$\frac{\partial L}{\partial W_2}=\color{blue}{\large\frac{\partial \text{outer}_{input}}{\partial W_2}}\,\color{red}{\large \frac{\partial L}{\partial \text{outer}_{input}}}\tag 1$$

$$\color{red}{\delta_0}=\color{red}{\large \frac{\partial L}{\partial \text{outer}_{input}}} = \frac{\partial L}{\partial \text{outer}_{output}}\,\frac{\partial \text{outer}_{output}}{\partial \text{outer}_{input}}= \color{red}{E_0 \circ D_0}$$
...
&=\frac{\partial L}{\partial \text{outer}_{output}}\,\frac{\partial \text{outer}_{output}}{\partial \text{outer}_{input}}\,\frac{\partial\text{outer}_{input}}{\partial \text{hidden}_{output}}\\[2ex]
&=\delta_0\cdot W_1^\top= E_0\circ D_0 \cdot W_1^T\\[2ex]
...
$$\begin{align}\delta_H&=\frac{\partial L}{\partial \text{hidden}_{output}}\,\frac{\partial \text{hidden}_{output}}{\partial\text{hidden}_{input}}\\[2ex]
&=E_H\circ D_H\\[2ex]
