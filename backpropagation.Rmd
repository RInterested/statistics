...
#####TOTAL ERROR of the NEURAL NETWORK (output of the outter layer to true values)
...
#####CHANGE IN ERROR WRT OUTPUT OF OUTTER LAYER NODE 1:
...
#####CHANGE IN OUTPUT OUTTER LAYER NODE 1 WRT ITS INPUT (SIGMOID ACTIVATION):
...
#####CHANGE IN INPUT OF OUTTER LAYER NODE 1 WRT $w_5$ (Logit linear equation):
...
#####CHANGE IN ERROR OF TARGET NEURON 1 OUTTER LAYER WRT OUTPUT OF HIDDEN LAYER NODE 1:
...
#####CHANGE IN ERROR OF TARGET OUTTER LAYER NEURON 2 WRT OUTPUT OF HIDDEN LAYER NODE 1:
