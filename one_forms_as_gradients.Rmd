...
As the basis vectors have decreased in magnitude (from m to cm), so has the spacing of the isolines. Contrast this to what the representation of the red arrow would have been if the measurement of horizontal distance had been transformed to kilometers from miles: the arrow would have become longer (contravariant).
