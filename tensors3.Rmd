...
$\beta \in V^*$ is $\beta=\color{blue}{\begin{bmatrix}\pi & \sqrt 5 &\sqrt 2 \end{bmatrix}}$ and $\gamma\in V^*$ is $\gamma=\color{red}{\begin{bmatrix}2 &4 &6 \end{bmatrix}}$. The $(2,0)$-tensor $\beta\otimes \gamma$ is the outer product:

$$\begin{align}\beta\otimes_o \gamma&=
\begin{bmatrix}\color{blue}\pi\times \color{red}2\quad e^1\otimes e^1
&\color{blue}\pi\times\color{red}4\quad e^1\otimes e^2
&\color{blue}\pi\times\color{red}6\quad e^1\otimes e^3\\
\color{blue}{\sqrt 5}\times\color{red}2\quad e^2\otimes e^1
&\color{blue}{\sqrt 5}\times\color{red}4\quad e^2\otimes e^2
&\color{blue}{\sqrt 5}\times\color{red}6\quad e^2\otimes e^3
\\\color{blue}{\sqrt 2}\times\color{red}2\quad e^3\otimes e^1
&\color{blue}{\sqrt 2}\times\color{red}4\quad e^3\otimes e^2
&\color{blue}{\sqrt 2}\times \color{red}6\quad e^3\otimes e^3\end{bmatrix}\\[2ex]
&=\begin{bmatrix}2\pi\quad e^1\otimes e^1&4\pi\quad e^1\otimes e^2&6\pi\quad e^1\otimes e^3\\2\sqrt 5\quad e^2\otimes e^1&4\sqrt 5\quad e^2\otimes e^2&6\sqrt 5\quad e^2\otimes e^3\\2\sqrt 2\quad e^3\otimes e^1&4\sqrt 2\quad e^3\otimes e^2&6 \sqrt 2\quad e^3\otimes e^3\end{bmatrix}
\end{align}$$
...
& \;\color{blue}\pi\times \color{red}2 \times \color{magenta}  1 \times \color{orange}2  \quad\quad \quad\quad+\quad   \color{blue}\pi\times\color{red}4 \times   \color{magenta}1  \times \color{orange} 0   \quad\quad\quad\quad +\quad    \color{blue}\pi\times\color{red}6 \times  \color{magenta}1  \times \color{orange}3 \\
+
&\color{blue}{\sqrt5}\times\color{red}2 \times \color{magenta}{-1} \times \color{orange}2  
\quad\quad \;+ \quad   
\color{blue}{\sqrt5}\times\color{red}4 \times  \color{magenta}{-1}  \times  \color{orange}0   
\quad\quad \;+ \quad  \color{blue}{\sqrt5}\times\color{red}6  \times \color{magenta}{-1}  \times \color{orange}3 \\
\;+
&\color{blue}{\sqrt2}\times\color{red}2 \times \color{magenta} 5 \times \color{orange}2  \quad\quad\quad+ \quad  
\color{blue}{\sqrt2}\times\color{red}4 \times  \color{magenta} 5  \times  \color{orange}0  
\quad \quad \quad+ \quad  
\color{blue}{\sqrt2}\times \color{red}6  \times  \color{magenta}5  \times \color{orange}3 \\[2ex]
&= 175.485\end{align}$$
...
Here is the idea with R code:
    ...
    v = c(1,-1,5); w = c(2,0,3); beta=c(pi,sqrt(5),sqrt(2)); gamma = c(2,4,6) 
...
& =(\color{blue}{\pi} \times \color{magenta} 1   \quad+\quad    \color{blue}{\sqrt 5} \times  \color{magenta}{-1}   \quad +\quad    \color{blue}{\sqrt 2}  \times  \color{magenta}5 )  
