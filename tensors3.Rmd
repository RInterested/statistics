...
The key is to distinguish these forms of tensor product of vector spaces from their **application to other vectors** (or covectors), i.e. when the $$<\beta_\mu\,e^\mu\;,\;A^\nu\,e_\nu>\;=\beta_\mu\,A^\nu\,<e^\mu\;,\;e_\nu>\;=\beta_\mu\,A^\nu\,\delta^\mu_{\;\nu}\;=\beta_\mu\,A^\mu\;\in \mathbb R$$ operations are carried out, yielding a real number - which is what is explained in the video. These operations are defined as **the dual space mapping**: $\langle e_i,e^j\rangle=\delta^i_j.$ 
