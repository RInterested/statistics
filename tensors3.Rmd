...
Now let's look at a $(0,2)$ tensor (a tensor with $0$ vectors and $2$ covectors), that is, a bilinear function $f:V\times V\to K$ - I tentatively would probably look like $\left(<\cdot,f>,<\cdot,f>\right).$ 
