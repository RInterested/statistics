...
$$\bbox[20px, border:2px solid red]{T: \underset{p}{\underbrace{V^*\times \cdots \times V^*}}\times \underset{q}{\underbrace{V\times \cdots  \times V}} \overset{\sim}\rightarrow K\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\,\;(1)}$$

The **$(p,q)$ TENSOR SPACE** ("the space of (p,q) tensors over a vector space V") is defined as a set:

$$\bbox[20px, border:2px solid red]{\begin{align}T^p_q\,V &= \underset{p}{\underbrace{V\color{darkorange}{\otimes}\cdots\color{darkorange}{\otimes} V}} \color{darkorange}{\otimes} \underset{q}{\underbrace{V^*\color{darkorange}{\otimes}\cdots\color{darkorange}{\otimes} V^*}}:=\{T\, |\, T\, \text{ is a (p,q) tensor}\}\quad\quad\quad(2)\\[3ex]&=\{T: \underset{p}{\underbrace{V^*\times \cdots \times V^*}}\times \underset{q}{\underbrace{V\times \cdots \times V}} \overset{\sim}\rightarrow K\}\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\,\;(3)\end{align}}$$ 
