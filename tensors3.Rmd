...
$$(T\color{blue}{\otimes}S)(\underbrace{v_1,\cdots,v_p,\cdots,v_{p+r}, \omega_1,\cdots,\omega_q,\cdots,w_{q+s}}_\text{"eats"... "the diet"}):= T(\underbrace{v_1,\cdots,v_p,\omega_1,\cdots,\omega_q}_{\text{"eats up" p vecs and q covecs yielding a no.}})\underbrace{\cdot}_{\text{in k}}S(\underbrace{v_{p+1},\cdots,v_{p+r},\omega_{q+1},\cdots,\omega_{q+s}}_{\text{"eats up" p vecs and q covecs yielding a no.}})$$
