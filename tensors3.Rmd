...
This is equivalent to the tensor product space $V^*\otimes V^*$ (the set of all tensor $(2,0))$ on the video. The presenter is tensor-multiplying two co-vectors in the vector basis of $V^*$, *without coefficients*, yielding the $16$ pairs of basis vectors of $V^*\otimes V^*$: $$\{e^0\otimes e^0, \; e^0\otimes e^1, \; e^0\otimes e^3, \;\cdots, e^4\otimes e^4\}.$$
...
$\beta \in V^*$ is $\beta=\begin{bmatrix}1 &2 &3 \end{bmatrix}$ and $\gamma\in V^*$ is $\gamma=\begin{bmatrix}-5 &4 &9 \end{bmatrix}$. The $(2,0)$-tensor $\beta\otimes \gamma$ is the outer product:

$$\beta\otimes_o \gamma=\begin{bmatrix}-05\;e^1\otimes e^1&04\;e^1\otimes e^2&09\;e^1\otimes e^3\\-10\;e^2\otimes e^1&08\;e^2\otimes e^2&18\;e^2\otimes e^3\\-15\;e^3\otimes e^1&12\;e^3\otimes e^2&27\;e^3\otimes e^3\end{bmatrix}$$

```
beta = 1:3; gamma = c(-5, 4, 9); beta %*% t(gamma)
     [,1] [,2] [,3]
[1,]   -5    4    9
[2,]  -10    8   18
[3,]  -15   12   27
...
& -05 \times  01 \times \;2   \quad\quad\,+\quad    04 \times   01  \;\times  0   \quad\quad \,\;+\quad    09  \,\times  01  \times 03 \\
+\;&-10 \times -1 \times 2  \quad \quad+ \quad   08 \times  -1 \; \times  0   \quad\quad \;+ \quad  18  \times -1  \times 03 \\
+\;&-15 \times  05 \times \;2  \quad \quad+ \quad  12 \times   05  \;\,\times  0  \quad\quad\,  \,+ \quad  27  \times  05 \; \times 03 \\[2ex]
&= 238\end{align}$$
...
```
v = c(1,-1,5); w = c(2,0,3); beta = 1:3; gamma = c(-5,4,9); beta %*% v * gamma %*% w
     [,1]
[1,]  238
```

$$\begin{align} (\beta \otimes \gamma)[v,w]&=\langle \beta,v \rangle \times \langle \gamma,w \rangle\\[2ex]
& =(1 \times  1   \quad+\quad    2 \times   -1   \quad +\quad    3  \times  5 )  
\times (-5 \times  2   \quad+\quad    4 \times   0   \quad +\quad    9  \times  3 ) \\[2ex]
&=14\times 17\\[2ex]
&= 238\end{align}$$
...
A tensor $A$ is a member of the $T^3_2$ tensor product , i.e. $A\in T^3_2(v),$ if is of the form $A^{\alpha\beta\gamma}{}_{\mu\nu}\, \underbrace {e_\alpha\otimes e_\beta\otimes e_\gamma}_{\text{basis vecs }\in V}\otimes \underbrace{e^\mu\otimes e^\nu}_{\text{covecs }\in V^*},$ meaning that it would "eat" $3$ covectors and $2$ vectors to produce a real number: $V^*\times V^* \times V^* \times V\times V\to \mathbb R.$ So, $T^{\text{no vecs in the tens product}}_{\text{no covecs in the tens prod}}$ or a $(3,2)$-rank tensor.
