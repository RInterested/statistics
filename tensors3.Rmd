...
$\beta \in V^*$ is $\beta=\begin{bmatrix}1 &2 &3 \end{bmatrix}$ and $\gamma\in V^*$ is $\gamma=\begin{bmatrix}2 &4 &6 \end{bmatrix}$. The $(2,0)$-tensor $\beta\otimes \gamma$ is the outer product:
...
$$V\times V\times V^*\times V\times V^* \to \mathbb R$$ would be the set of all possible tensor products of the form $$T_{\mu\;\nu}{}^{\gamma}{}_\rho{}^\eta\quad e^\mu\otimes  e^\nu\otimes e _\gamma\otimes e^\rho \otimes e_\eta$$
