...
plot(VTI.raw$Date, VTI.raw$InterDay < -4, pch=19, col=2, type='h', xlab="Year", ylab="Days with > 4% change", cex.axis=.5, cex.main=.8, cex.lab =.5,las=2, main  = "Clustering of big drop days")
```
