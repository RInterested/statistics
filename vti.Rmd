...
Between the start of the crisis around September 2008, and the nadir, on March 06, 2009, there was a loss of

```{r}
(drop = as.numeric(VTI$Adj.Close["2009-03-06"]) - as.numeric(VTI$Adj.Close["2008-09-10"]))
