...
The "geometry" of a p-adic circle is nothing like the one you draw on a piece of paper. Here is a Gemini depiction of a circle as the folders at the same depth inside a Windows Explorer system (explained later on):
...
$\mathbb Q_z$ contains those same numbers, plus a finite fractional part to the right of the radix point (negative powers like $p^{-1}, p^{-2}, \dots$):

---

$\dots d_3 d_2 d_1 d_0\; \color{red}.\; d_{-1}d_{-2}\dots d_{-k}\; = \;d_{-k}\, p^{-k} + \dots + d_{-1}\, p^{-1} + d_{-1}\, p^{-1}+ d_0\, p^0 + d_1 \, p^1 + d_2\, p^2 + \cdots$
...
<h1 style="text-align: left; color: #2c3e50; font-family: Inter, system-ui, sans-serif; font-weight: 250; border-bottom: 2px solid #2c3e50; padding-bottom: 0.2em;">
  Positive integers:
</h1>
