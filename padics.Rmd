...
The "geometry" of a $p$-adic circle is nothing like the one you draw on a piece of paper. In the $p$-adic world, trigonometry exists through power series, but the lack of $\pi$ means the functions behave in ways that would baffle a high school geometry student. Here is how we compute "circular" things in $\mathbb{Q}_p$ without $\pi$:
