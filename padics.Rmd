...
| Power | Current<br> $\tiny a_i=\frac{\text{Quot - Rem}}5$ |Mod<br> $5$| Digit<br> $b_i$ | Subtraction<br> $\small a_i - b_i$ | New<br>$\small a_{i+1}=\frac{a_i}5$ |Partial sums<br> $\small x_n = 4357 \pmod{5^n}$ | Consistency<br>$\small x_n \equiv x_{n-1} \pmod{5^{n-1}}$ |
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
