...
When we write the integer 4357 in base-10, we don't usually write $...000004357$. We assume the infinite string of zeros to the left. In the $p$-adic sequence $(x_1, x_2, x_3, \dots)$, once $p^n$ becomes larger than the integer itself (for $4357$ and $p=5$, this happens at $5^6 = 15625$), the remainder $x_n$ simply becomes the number itself. $x_6 = 4357 \pmod{15625} = 4357,$ $x_7 = 4357 \pmod{78125} = 4357,$ $x_n = 4357$ for all $n \ge 6$. So, while the sequence is an infinite object $(2, 7, 107, 607, 1232, 4357, 4357, 4357, \dots)$, it stabilizes. This is why we say the natural integers $\mathbb{Z}$ are "embedded" inside the $p$-adic integers $\mathbb{Z}_p$.
