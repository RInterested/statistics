...
$$B_{p^{-n}}(a) = \{ x \in \mathbb{Q}_p : |x - a|_p \leq p^{-(n+1)} \}$$
...
If you add these two infinite strings together using base-5 arithmetic, you get $\dots 00000_5$ (zero). If you multiply them, you get the expansion for $+1$. But if you square either of them, the resulting "carry" process produces:
