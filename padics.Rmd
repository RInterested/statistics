...
To calculate $\chi_x(q)$ for a value like $2.3$ in a $p$-adic system (let's stick with $p=3$), we first convert $2.3$ into a fraction: $2.3 = \frac{23}{10}$. We want to find the color of the number $x = \frac{23}{10}$ at the torus level ($q = \frac{1}{3}$). First we multiply $x$ by $q$

$$x \cdot q = \frac{23}{10} \cdot \frac{1}{3} = \frac{23}{30}$$

We find the fractional part $\{\frac{23}{30}\}_3$ by looking for the pieces of the number that have $3$ in the denominator. We use partial fraction decomposition to separate the "3-part" from the "non-3-part":

$$\frac{23}{30} = \frac{A}{3} + \frac{B}{10}$$

Solving for $A$, we find that $\frac{23}{30} = \frac{1}{3} + \frac{13}{30}$.

The part that "vibrates" in the $3$-adic world is the $1/3$. 

Next we identify the Remainder

$$\{2.3 \cdot \frac{1}{3}\}_3 = \frac{1}{3}$$

Finally, we take that fraction and turn it into a position on the torus: 

Fractional Part: $1/3$

Degrees: $1/3 \times 360^\circ = \mathbf{120^\circ}$ Color: Green
