...
>        
> **$p$-adic quotients**: these aret he **a**', Since you are performing the operation $a_{i+1} = (a_i - d_i) / p$, you are essentially finding the integer quotient of the previous value. 
...
Take the number $4357$. Whether you use the "telescope" (base $5$) or "microscope" ($5$-adic) method, you are solving for the unique set of coefficients $\{b_i\}$ in this identity:
