...
Step 1: $x_1 = 2 - \frac{2^2 - 6}{2(2)} = 2 - \frac{-2}{4} = \mathbf{2.5}$

Step 2: $x_2 = 2.5 - \frac{2.5^2 - 6}{2(2.5)} = 2.5 - \frac{0.25}{5} = \mathbf{2.45}$
...
Step 0 ($x_0$): Let's pick $x_0 = 1.5$.

Step 1: $x_1 = 1.5 - \frac{1.5^2 - 2}{2(1.5)} = 1.5 - \frac{0.25}{3} = 1.4166...$

Step 2: $x_2 = 1.4166 - \frac{1.4166^2 - 2}{2(1.4166)} \approx \mathbf{1.414215...}$
