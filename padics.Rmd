...
$128 \div 5 = \text{Quotient }=25$ with a remainder of $\text{Re }=3.$

Divide the quotient $(25)$ by $5:$

$25 \div 5 = \text{Quotient }=5$ with a remainder of $\text{Re }=0.$

Divide the quotient $(5)$ by $5:$

$5 \div 5 = \text{Quotient }=1$ with a remainder of $\text{Re }=0.$

Divide the quotient $(1)$ by $5:$

$1 \div 5 = \text{Quotient }=0$ with a remainder of \text{Re }=1.$

The digits we found $(3, 0, 0, 1)$ are the coefficients for the powers of $5.$ In $5$-adic notation, $128$ is expressed as:
