...
| :--- | :--- | :--- | :--- | :---|
| $5^5$ (3,125) | $4357 \div 3125$ | $1 = b_5$$\color{red}\downarrow$|$4357-1 \cdot 5^5$  | $1,232$ |
| $5^4$ (625) | $1232 \div 625$ | $1 = b_4$$\color{red}\downarrow$|$1232-1\cdot 5^4$ |$607$ |
| $5^3$ (125) | $607 \div 125$ | $4= b_3$ $\color{red}\downarrow$|$607 - 4 \cdot 5^3$| $107$ |
| $5^2$ (25) | $107 \div 25$ | $4=b_2$$\color{red}\downarrow$|$107 - 4\cdot 5^2$ | $7$ |
| $5^1$ (5) | $7 \div 5$ | $1=b_1$$\color{red}\downarrow$|$7- 1\cdot 5^1$ | $2$ |
| $5^0$ (1) | $2 \div 1$ | $2=b_0$$\color{red}\downarrow$| $2 - 2\cdot 5^0$ | $0$ |
...
We represent $4,357$ as $a/c$ where $a = 4357$ and $c = 1$. We solve $1 \cdot d \equiv a \pmod 5$ at each level.

|Power | Current $a$ | Digit $b_i$ (or $d$) || Subtraction ($a - b_i$) | New a (a/5) |
|:--- | :--- | :--- | :--- |:---| :--- |
|$5^0$ | $4,357$ | $\small 4357\mod 5 = 2=b_0$|$\color{blue}\downarrow$ | $4357 - 2 = 4355$ | $\frac{4355}5= 871$|
|$5^1$ | $871$ | $\small 871 \mod 5 = 1=b_1$ |$\color{blue}\downarrow$| $871 - 1 = 870$ |$\frac{870}5= 174$ |
|$5^2$ | $174$ | $\small 174 \mod 5 = 4=b_2$ |$\color{blue}\downarrow$| $174 - 4 = 170$ | $\frac{170}5=34$ |
|$5^3$ | $34$ | $\small 34 \mod 5 =4 =b_3$ |$\color{blue}\downarrow$| $34 - 4 = 30$ |$\frac{30}5= 6$ |
|$5^4$ | $6$ | $\small 6 \mod 5 = 1=b_4$ |$\color{blue}\downarrow$| $6 - 1 = 5$ | $\frac5 5 =1$ |
|$5^5$ | $1$ | $\small 1 \mod 5 =1=b_5$ |$\color{blue}\downarrow$| $1 - 1 = 0$ |$\frac{0}5 = 0$ |
...
Sum: $4,357$ In $5$-adic notation: Written from the lowest power to the highest, the expansion is 2, 1, 4, 4, 1, 1. In standard $p$-adic form (infinite zeros to the left), it is written as: $...000114412$. In base $5$ notation: Written from the highest power to the lowest, it is $114412_5$.
...
<img width = 800  src = "padic_windows_explorer.png">
...
We choose a $5$-adic metric because in this tree system every folder has capacity for exactly $5$ slots (files or sub-folders). Think of $p$ as the scaling constant. It defines how much the world "shrinks" every time you double-click into a folder: At $p=2$, files in the same folder are $1/2$ as far apart as strangers. At $p=5$, files in the same folder are $1/5$ as far apart as strangers. If you choose a larger $p$, you are essentially saying that siblings are much closer to each other than they are to anyone else. Using $p=5$ makes the math very clear:
