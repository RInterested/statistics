...
- Base $5$ (Real): $0.\mathbf{131313...}$

- $5$-adic: $...\mathbf{313132}$
...
- Step 1 ($d_0$): Solve $3x \equiv 1 \pmod 5$.$3 \times \mathbf{2} = 6 \equiv 1$. So $d_0 = 2$.
- Step 2 ($d_1$): Subtract your progress and divide by 5.$(1/3 - 2) / 5 = (-5/3) / 5 = -1/3$. Solve $3x \equiv -1 \pmod 5$.$3 \times \mathbf{3} = 9 \equiv -1$. So $d_1 = 3$.
- Step 3 ($d_2$): Repeat.$(-1/3 - 3) / 5 = (-10/3) / 5 = -2/3$. Solve $3x \equiv -2 \pmod 5$.$3 \times \mathbf{1} = 3 \equiv -2$. So $d_2 = 1$.
- Result: $...132_5$
...
$$d(\text{just}, \text{budget}) = 5^{-3}$$$$d(\text{just}, \text{budget}) = \frac{1}{5 \times 5 \times 5} = \frac{1}{125}$$
Distance $= 0.008$.
