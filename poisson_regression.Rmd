...
data$rate <- with(data, infarcts/stdpop*10^5)

plot(data$rate, ylim=c(00,300), xlab="Year", ylab="Std rate x 10,000", 
      pch=19, bty="l", xaxt="n")
...
From [here](https://stats.stackexchange.com/a/74426/67822) and [here](https://stats.stackexchange.com/a/57761/67822).

```{R}
x <- ts(data$infarcts, frequency=12) # 12 measurements per year
fit <- tbats(x)
