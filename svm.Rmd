...
And equivalent condition would be:
...
First constraint we are going to impose is that for any positive sample $x_+$ (we could have used $u_+$), $\color{blue}{w}\cdot \bf x_+ + b \geq 1$ and $\color{blue}{w}\cdot \bf x_- + b \leq -1$. 

<br>
<img width="500" src="https://cloud.githubusercontent.com/assets/9312897/22207669/ef0119de-e14d-11e6-80f2-1cef812a859d.png">
<br>
...
So we establish that this has to be greater than zero, *but* if the example is "in the gutter", then:
