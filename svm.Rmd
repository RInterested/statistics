...
In the division boundary the value would be $0$, leaving the values of the different strips as:


<br>

<img width="250" src="https://cloud.githubusercontent.com/assets/9312897/22253623/4fe02998-e220-11e6-9e32-9e698c1a1b54.png">
...
So we establish that this has to be greater than zero, *but* if the example is "in the gutter" (the **dividing hyperplanes**, or in this case lines, corresponding to the tips of the supporting vectors), then:
