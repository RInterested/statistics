...
<img height="500" width="500" src="https://cloud.githubusercontent.com/assets/9312897/16438253/f52790e8-3d7b-11e6-8846-56d147c60e0f.png">


As in the illustration above, if we select an orthogonal vector such that $\large \lVert w \rVert=1$ we can establish a decision criterium for any example to be catalogued as positive of the form:
...
$$\Large \mathscr{L} = \frac{1}{2} \lVert w \rVert^2 - \sum \lambda_i [y_i ({\bf x_i\cdot \color{blue}{w} }+ b) -1]\tag{Lagrange: Eq.5}$$
