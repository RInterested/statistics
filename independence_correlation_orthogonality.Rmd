...
A similar example could be $X \sim \text{Unif}(-1,1)$ and $Y=\vert X \vert.$ I am not sure if they are mathematically uncorrelated and orthogonal - definitely not independent:
