...
DELTASQ.EXP <- round((as.data.frame(tab)[,1] - EXP.FR.)^2/EXP.FR.)
(dat<-data.frame(tab, Upp.Bound, Z.vals, area.below, area.bin, EXP.FR., DELTASQ.EXP))
...
dat$EXP.FR. <- EXP.FR.
dat$DELTASQ.EXP <- (OBS.FR. - EXP.FR.)^2/EXP.FR.
