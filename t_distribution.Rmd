...
In a nutshell, there aren't $n$ $X_i$ independently distributed random variables corresponding to the different observations, each one following a $\chi^2$ distribution. In fact there are only $n-1$ because of the insertion of the $\bar X$ in the mix.

<br><br>

###DERIVATION OF THE $pdf$ OF THE $t$ DISTRIBUTION:([here][6])
