...
[XylyXylyX](https://youtu.be/hK3lt6ovgYc?t=16m59s) labels the vector that the vector field places at $x + \delta x,$ i.e. the position in space-time shifted by small incremenet, 
...
as $X^\alpha(x+\delta x),$ with a [Taylor expansion](https://physics.stackexchange.com/q/361380/150551):


$$\begin{align}
X^\alpha\,(x + \delta x) &= X^\alpha (x)+\delta x^b\;\partial_bX^\alpha+\cdots\\[2ex]
&=X^\alpha(x) + \delta x^b\;\frac{\partial X^\alpha}{\partial x^b}+\cdots\\[2ex]
&= X^\alpha(x) + \delta X^\alpha + \cdots
\end{align}$$
...
As we move on the manifold, the basis will change...
