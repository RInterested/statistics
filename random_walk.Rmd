...
$$p_{2n}=P(x_{2n}=0) = {2n \choose n}\,\Big(pq\Big)^n \tag 1$$
...
$$f_{2n} = P(x_{2n}=0 \text{ and } x_{2k}\neq 0 \text{ for all } k<n)$$
...
If $x=1$,the sum of all the $f_n$ is simply the probability that the random walk ever returns to the origin :
