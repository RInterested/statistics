...
These vectors are the solution to the homogeneous system of linear equations, and span the null space of $A$, plus they are linearly independent. Hence they are a basis of the null space. It has a dimension of $3$, corresponding to the number of free variables.

A basis for the column space of $A$ can be obtained from the pivot columns **of the original** $A.$
