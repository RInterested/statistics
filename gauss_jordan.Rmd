...
A $\color{blue}{\text{basis of the null space of the transposed (left null space) }N(A^\top)}$ can be obtained by transposing the bottom rows of $E$, corresponding to the zero rows in the echelon form: $\begin{bmatrix}3&-4\\1&0\\-5&5\\0&1\end{bmatrix}.$
