...
The reduced row echelon is meant to obtain the constraint equations:
...
From this rref, the pivot columns are expressed in terms of the free variables, which only depend on themselves, to obtain the general solution, as well as a basis of the null space of $A:$
...
0&0&0&0&0
\end{bmatrix}
\vec x=\begin{bmatrix}0\\0\\0\\0\end{bmatrix}$$

Therefore, the combinations of column vectors elementwise in the solution of the homogeneous system of equations can be expressed as
