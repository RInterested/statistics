...
$S_p$ is the *pooled* standard deviation across both samples. It is the square root of the mean of *variances* when the sample size is the same: $\large S_p=\sqrt{\mathrm{SD}_x^2+\mathrm{SD}_y^2}$. It follows a $t$ distribution with $n_x + n_y - 2$ degrees of freedom.
