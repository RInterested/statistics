...
$\text{Accuracy or % correct classif.} = \frac{TP+TN}{TP\, +\, FP +\, TN +\, FN}$

![](https://user-images.githubusercontent.com/9312897/87494311-a9e59200-c61c-11ea-99b9-3e6c2debaa49.png)

---

$\text{% incorrect classif.} = \frac{FP+FN}{TP\, +\, FP +\, TN +\, FN}$
...
thresh <- thres2(k1, k2, rho, costs, "empirical", ci.method='boot', extra.info=T)
