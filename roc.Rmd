...
This material was extracted from [here](https://www.google.com/url?sa=t&rct=j&q=&esrc=s&source=web&cd=21&cad=rja&uact=8&ved=0ahUKEwinjdHJ_oLLAhWBmR4KHTY8Axs4FBAWCBswAA&url=http%3A%2F%2Fr-es.org%2Fdl1192&usg=AFQjCNFxRXWxz4SWoOgzIFn_jzIAGKxNsQ&sig2=ELFkO23EgdBPH_6GjEkVvA).
...
Looking at the PSA in relation to whether the diagnosis was or was not made:

```{r}
boxplot(data$fpsa ~ data$d, main = "Boxplot of FPSA ~ diagnosis", col = 'gray90', border='gray50', pch= 19)
```
...
```{r}
# With total PSA:
plot.roc(data$d, data$tpsa, print.auc = TRUE)
