...
where $X$ is a random variable with pdf $f(x)$, and $n$ signifies the $n$-th moment.
...
$$\large \displaystyle \int_{-\infty}^{\infty} x f(x)dx.$$
...
$\mathscr F\{f(x)\}=\displaystyle \int_{-\infty}^{\infty}e^{2\pi i k x}\,f(x)\,dx$
