...
$$G^{(2)}\;(1) =\frac{d^2}{dz^2}\; \left.\mathbb E\left[z^X\right]\right|_{z=1}=\mathbb E\left[X\;(X-1)\;z^{X-2}\right]=\mathbb E\left[X\;(X-1)\right]=\mathbb E\left [X^2-X\right ]=\mathbb E\left[X^2\right] - \mathbb E\left[X\right]$$
...
$$\sigma^2=\mathbb E\left[X^2\right]-\mathbb E\left[X\right]^2=G^{(2)}\;(1)+G^{(1)}\;(1)-\left[G^{(1)}\;(1)\right]^2$$
