...
We carry out a Taylor expansion of the exponent $f(x) = n \ln x - x$ around its peak at $x = n$. 
The general formula for a Taylor expansion up to the second degree is:
