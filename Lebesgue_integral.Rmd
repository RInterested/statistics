...
The range or codomain of the function $f$ is partitioned fixing a maximum value $n$ into $k=0$ to $k = n$ intervals at intervals $\frac{k}{2^n}$ in order to define a sequence of simple functions $f_n$ with value $n$ if $f(\omega)$ is equal or greater than $n,$ and otherwise with the lowest value for that interval, $n-\frac{1}{2^n}.$

<img  src="https://user-images.githubusercontent.com/9312897/114963279-62ee2c80-9e3a-11eb-9904-968e9078bcd4.png">
