...
the generalization of the beta distribution that provides a prior for this categorical distribution is the Dirichet distribution with the pdf defined as
...
wehre $\alpha_0:=\sum_{k=1}^K \alpha_k.$
